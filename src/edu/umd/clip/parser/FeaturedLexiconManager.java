        ...
        if (!wordPredPredefined) {
            ...
            switch (lang) {
                case english: {
                    ...
                    PredicateExtractor wordVectorExtractor = new WordVectorExtractor();
                    ...
                    predicateExtractorList.add(wordVectorExtractor);
                ...
                case triple_english: {
                    PredicateExtractor wordIdentityExtractor = new TripleExtractor(new WordIdentityExtractor());
                    PredicateExtractor prefixSuffixExtractor = new TripleExtractor(new PrefixSuffixExtractor());
                    PredicateExtractor digitInitcaseHyphen = new TripleExtractor(new DigitCaseHyphenExtractor());
                ...
                default: {
                    throw new Error(String.format("lang=%s is not supported", lang));
                }
            }
            wordPredSet = new BiSet<String, String>();
    ...
    public void mergeStates(int[] newNumStates) {
        for (HashMap<Integer, DoubleArray> pnWeightMaps : predLatentTagWeightsMap.values()) {
            for (Entry<Integer, DoubleArray> pnWeightEntry : pnWeightMaps.entrySet()) {
                ...
                //System.out.println(newStateNum);
                //System.out.println(oldStateNum);
