...
public class GrammarTrainer {
    ...
    public static class Options {
        ...
        @Option(name = "-lexicon", usage = "Type of lexicon to use [berkeley, featured, simple, rbf] (Default: berkeley)")
        public Grammar.Lexicon lexiconType = Grammar.Lexicon.berkeley;
        // WARNING: doesn't actually set this everywhere (may need to fix in code)
        @Option(name = "-embeddingsPath", usage = "WARNING: doesn't do everything you expect (see code)")
    ...
    public static void main(String[] args) throws Exception {
        ...
        if (opts.lexiconType == Grammar.Lexicon.featured) {
            opts.useFeatureLexicon = true;
        }

        int initSplit = 1;
        Grammar grammar = null;
        if (opts.initGrammar == null) {
            // TODO(jda) separate embeddingsPath more cleanly
            grammar = new Grammar(opts.lang, opts.lexiconType, opts.embeddingsPath);
        } else {
