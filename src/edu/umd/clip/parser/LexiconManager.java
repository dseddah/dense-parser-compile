...
public class LexiconManager implements Serializable, Cloneable {
    ...
    public void doMStep() {
        ...
        //System.out.println(latentTagWordProbsMap.get(60, "best"));
        //System.out.println(latentTagWordProbsMap.get(62, "best"));
    }
...
//        }
    ...
    public double[] getProbs(int tag, String word, boolean viterbi) {
        System.out.println("decode-time getProbs called on " + getClass().getName());
